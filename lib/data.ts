...
export const MARKETS: Market[] = [
  {
    ...
    kolHandle: "@alphajeet",
    badge: "hot",
    question: "Will AlphaJeet make 100 SOL today?",
    yesPct: 64,
    noPct: 36,
    pool: "182 SOL",
    timerId: "t1",
  ...
  },
  {
    ...
    kolHandle: "@solbull",
    badge: "live",
    question: "Will SolBull's next post hit 100 likes?",
    yesPct: 71,
    noPct: 29,
    pool: "96 SOL",
    timerId: "t2",
  ...
  },
  {
    ...
    kolColor: "orange",
    kolName: "CryptoKing",
    kolHandle: "@cryptoking",
    badge: "live",
    question: "Will CryptoKing post 3+ times today?",
    yesPct: 45,
    noPct: 55,
    pool: "54 SOL",
    timerId: "t3",
  ...
  },
  {
    ...
    kolHandle: "@degenguru",
    badge: "soon",
    question: "Will DegenGuru's call 10x in 24h?",
    yesPct: 22,
    noPct: 78,
    pool: "210 SOL",
